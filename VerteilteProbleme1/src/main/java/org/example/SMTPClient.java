...
public class SMTPClient {
    ...
    private static final byte[] messageChars = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', ' '};
    ...
    private static void initMessages() {
        ...
        heloMsg = "HELO ".getBytes(messageCharset);
        crnlMsg = "\r\n".getBytes(messageCharset);
        mailFromMsg = "MAIL FROM: ".getBytes(messageCharset);
        rcptToMsg = "RCPT TO: ".getBytes(messageCharset);
        dataMsg = "DATA".getBytes(messageCharset);
        quitMsg = "QUIT".getBytes(messageCharset);
        helpMsg = "HELP".getBytes(messageCharset);
    }
    ...
    private static void initDummyAddresses() {
        ...
        dummyAddress1 = "abc@def.edu".getBytes(messageCharset);
        dummyAddress2 = "ghi@jkl.com".getBytes(messageCharset);
        dummyAddress3 = "nmo@pqr.gov".getBytes(messageCharset);
        dummyAddress4 = "stu@vwx.de".getBytes(messageCharset);
    }
